<?php
/**
 * API: Save/Update Life Report Data
 * บันทึกข้อมูลร่างรายงานคดีชีวิต (ในอาคาร/นอกอาคาร)
...
$reportType = $input['report_type'] ?? ''; // 'indoor' or 'outdoor'
...
if (!in_array($reportType, ['indoor', 'outdoor'])) {
...
try {
    ...
    echo json_encode([
        'success' => true,
        'message' => 'บันทึกร่างรายงานเรียบร้อยแล้ว'
