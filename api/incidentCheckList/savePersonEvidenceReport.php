<?php
/**
 * API: Save/Update Person Evidence Report Data
 * บันทึกข้อมูลร่างรายงานตรวจเก็บวัตถุพยานบุคคล
...
try {
    ...
    // เก็บข้อมูลใน key 'person_evidence'
    $currentReportData['person_evidence'] = $formData;
    ...
    echo json_encode([
        'success' => true,
        'message' => 'บันทึกร่างรายงานตรวจเก็บวัตถุพยานบุคคลเรียบร้อยแล้ว'
