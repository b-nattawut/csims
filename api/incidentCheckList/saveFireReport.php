<?php
/**
 * API: Save/Update Fire Report Data
 * บันทึกข้อมูลร่างรายงานคดีเพลิงไหม้
...
try {
    ...
    // เก็บข้อมูลใน key 'fire'
    $currentReportData['fire'] = $formData;
    ...
    echo json_encode([
        'success' => true,
        'message' => 'บันทึกร่างรายงานเพลิงไหม้เรียบร้อยแล้ว'
