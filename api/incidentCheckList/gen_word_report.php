 ...
 *   photos = all   ค่าเริ่มต้นและโหมดร่างรายงาน — เนื้อหา + รูปในไฟล์เดียว
 *                  เลขหน้า {PAGE}/{NUMPAGES} นับรวมทั้งฉบับ (เช่น 4/26)
 *          | none  เฉพาะเนื้อหา (legacy)
 *          | only  เฉพาะภาพประกอบ แยกไฟล์ เริ่มนับหน้าที่ 1 (legacy)
 */
